...
enum ButtonMask_e {
	...
	BtnMask_JClick = 1 << BtnIdx_JClick,
...
const LightgunButtons::Desc_t LightgunButtons::ButtonDesc[] = {
    ...
    {8, LightgunButtons::ReportType_Keyboard, KEY_1, 20, BTN_AG_MASK2, "Start"},
	...
	{4, LightgunButtons::ReportType_Keyboard, KEY_A, 25, BTN_AG_MASK2, "JClick"},
(5, LightgunButtons::ReportType_Mouse, MOUSE_MIDDLE, 20, BTN_AG_MASK2, "Coin"},
