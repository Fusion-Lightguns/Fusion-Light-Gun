...
const LightgunButtons::Desc_t LightgunButtons::ButtonDesc[] = {
    ...
    {4, LightgunButtons::ReportType_Keyboard, KEY_TAB, 25, BTN_AG_MASK, "Coin"},
    {5, LightgunButtons::ReportType_Mouse, MOUSE_MIDDLE, 20, BTN_AG_MASK, "Pedal"},
    {6, LightgunButtons::ReportType_Keyboard, KEY_RETURN, 25, BTN_AG_MASK2, "A"},
    {7, LightgunButtons::ReportType_Keyboard, KEY_ESC, 25, BTN_AG_MASK2, "B"},
    {8, LightgunButtons::ReportType_Keyboard, KEY_1, 25, BTN_AG_MASK2, "Start"},
    {9, LightgunButtons::ReportType_Keyboard, KEY_5, 25, BTN_AG_MASK2, "Select"},
