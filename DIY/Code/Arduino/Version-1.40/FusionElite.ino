 ...
 * @date 2023
 ...
 /* This is a open source lightgun modified from Samco Lightgun & Mike Lynch code
 * I (Gonezo) added the following
    - More Buttons 
    - Different button assignments. Geared more towards Retro Gaming
    - Changed Pedal To Reload 
    - Changed Reload to Calibrate
    - Cleaned up code
...
const LightgunButtons::Desc_t LightgunButtons::ButtonDesc[] = {
    ...
    {9, LightgunButtons::ReportType_Keyboard, KEY_1, 20, BTN_AG_MASK2, "Start"},
    {8, LightgunButtons::ReportType_Keyboard, KEY_5, 25, BTN_AG_MASK2, "Select"},
    {7, LightgunButtons::ReportType_Keyboard, KEY_LEFT_ALT, 25, BTN_AG_MASK2, "A"},
    ...
    {5, LightgunButtons::ReportType_Keyboard, KEY_6, 25, BTN_AG_MASK2, "P2Select"},
    {4, LightgunButtons::ReportType_Keyboard, KEY_2, 25, BTN_AG_MASK2, "P2Start"},
    {15, LightgunButtons::ReportType_Mouse, MOUSE_MIDDLE, 20, BTN_AG_MASK2, "Mouse3"}
};
