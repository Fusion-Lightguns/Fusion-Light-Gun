...
/* ------------------ START/PAUSE MOUSE ---------------------- */
  ...
  /* -------------------- OFFSET ------------------------- */
    ...
    MoveYAxis = map (finalY, (yCenter + ((myFusionVolt.H() * (yOffset / 100)) / 2)), (yCenter - ((myFusionVolt.H() * (yOffset / 100)) / 2)), 0, res_y);
    ...
    MoveXAxis = map (finalX, (xCenter + ((myFusionVolt.H() * (xOffset / 100)) / 2)), (xCenter - ((myFusionVolt.H() * (xOffset / 100)) / 2)), 0, res_x);
...
myDFRobotIRPosition.requestPosition();
    ...
    myFusionVolt.begin(myDFRobotIRPosition.readX(0), myDFRobotIRPosition.readY(0), myDFRobotIRPosition.readX(1), myDFRobotIRPosition.readY(1),myDFRobotIRPosition.readX(2), myDFRobotIRPosition.readY(2),myDFRobotIRPosition.readX(3), myDFRobotIRPosition.readY(3), xCenter, yCenter);
    finalX = myFusionVolt.X();
    finalY = myFusionVolt.Y();
    }
    else {
...
void go() {    // Setup Start Calibration Button
  ...
  buttonState1 = digitalRead(_calibratePin);
...
void mouseButtons() {    // Setup Left, Right & Middle Mouse buttons
  ...
  buttonState3 = digitalRead(_APin);
  buttonState4 = digitalRead(_BPin);
  buttonState5 = digitalRead(_startPin);      
  buttonState6 = digitalRead(_selectPin); 
  buttonState7 = digitalRead(_reloadPin); 
