...
//#de222222222222222222222222222222222222222222222222222222fine DEBUG_SERIAL 2
...
const LightgunButtons::Desc_t LightgunButtons::ButtonDesc[] = {
    ...
    {4, LightgunButtons::ReportType_Keyboard, KEY_BACKSPACE, 25, BTN_AG_MASK, "Coin"},
    {5, LightgunButtons::ReportType_Mouse, MOUSE_MIDDLE, 20, BTN_AG_MASK, "Pedal"},
    {6, LightgunButtons::ReportType_Keyboard, KEY_LEFT_CTRL, 25, BTN_AG_MASK2, "A"},
    {7, LightgunButtons::ReportType_Keyboard, KEY_LEFT_SHIFT, 25, BTN_AG_MASK2, "B"},
    {8, LightgunButtons::ReportType_Keyboard, KEY_2, 25, BTN_AG_MASK2, "Start"},
    {9, LightgunButtons::ReportType_Keyboard, KEY_6, 25, BTN_AG_MASK2, "Select"},
    {14, LightgunButtons::ReportType_Keyboard, KEY_F4, 25, BTN_AG_MASK2, "Calibrate"},
...
const int RecoilPin = 5;       // the number of the recoil pin
// run modes
...
FusionPreferences fusionPreferences;
...
void RecoilAction()
{
digitalWrite(RecoilPin, HIGH); //turn recoil on
digitalWrite(RecoilPin, LOW); //turn recoil off
}
...
#else
    nvPrefsError = fusionPreferences.Load();
#endif // FUSION_FLASH_ENABLE
    VerifyPreferences();
}
